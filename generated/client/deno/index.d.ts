...
export namespace Prisma {
  ...
  */
  ...
  export type PostGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'author' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Post ? Post[P] : never
  } 
    : Post
  : Post
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'profiles' ? Array < ProfileGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'profiles' ? Array < ProfileGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
